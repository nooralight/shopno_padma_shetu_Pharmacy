...
urlpatterns=[
    ...
    path('edit_shop_product/<int:id>/' , views.gotoEdit_product_shop, name= 'editProduct-shop'),
    path('edit_shop_product_image/<int:id>/' , views.gotoEdit_Image_product_shop, name= 'editProduct-shop-image'),
    path('editing_shop_product/<int:id>/' , views.edit_product_shop, name= 'edit-shop-product'),
    path('editing_shop_product_image/<int:id>/' , views.edit_product_image_shop, name= 'edit-shop-product-image'),
